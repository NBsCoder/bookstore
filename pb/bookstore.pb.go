...
type Shelf struct {
	...
	Theme string `protobuf:"bytes,2,opt,name=theme,proto3" json:"theme,omitempty"` // 主题（历史、小说等）
...
type Book struct {
	...
	Title  string `protobuf:"bytes,3,opt,name=title,proto3" json:"title,omitempty"`   // 书名
}
...
type CreateShelfRequest struct {
	...
	Shelf *Shelf `protobuf:"bytes,1,opt,name=shelf,proto3" json:"shelf,omitempty"` // 创建书架需要的消息
}
...
type ListBooksRequest struct {
	...
	Shelf int64 `protobuf:"varint,1,opt,name=shelf,proto3" json:"shelf,omitempty"` //  ID of the shelf which books to list.
}
...
type CreateBookRequest struct {
	...
	Shelf int64 `protobuf:"varint,1,opt,name=shelf,proto3" json:"shelf,omitempty"` // 书本放置的书架的ID
...
type GetBookRequest struct {
	...
	Shelf int64 `protobuf:"varint,1,opt,name=shelf,proto3" json:"shelf,omitempty"` // 书架ID
	Book  int64 `protobuf:"varint,2,opt,name=book,proto3" json:"book,omitempty"`   // 图书ID
}
...
var file_bookstore_proto_rawDesc = []byte{
	...
	0x2f, 0x7b, 0x62, 0x6f, 0x6f, 0x6b, 0x7d, 0x42, 0x0e, 0x5a, 0x0c, 0x62, 0x6f, 0x6f, 0x6b, 0x73,
